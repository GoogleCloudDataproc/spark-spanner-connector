...
public class Spark40SchemaValidationIntegrationTest extends SchemaValidationIntegrationTestBase {
  public Spark40SchemaValidationIntegrationTest(boolean usePostgreSql) {
    super(usePostgreSql);
  }
