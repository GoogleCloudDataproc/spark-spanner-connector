...
public final class Spark32DataprocImage20AcceptanceTest extends DataprocAcceptanceTestBase {

  private static AcceptanceTestContext context;
  public static final String CONNECTOR_JAR_DIRECTORY = "../spark-3.2-spanner/target";

  public Spark32DataprocImage20AcceptanceTest() {
    super(context);
  }
  ...
  public static void setup() throws Exception {
    context =
        DataprocAcceptanceTestBase.setup(
            "2.0-debian10", CONNECTOR_JAR_DIRECTORY, "spark-3.2-spanner", ImmutableList.of());
  }
