...
public final class Spark32DataprocImage22AcceptanceTest extends DataprocAcceptanceTestBase {

  private static AcceptanceTestContext context;
  public static final String CONNECTOR_JAR_DIRECTORY = "../spark-3.2-spanner/target";

  public Spark32DataprocImage22AcceptanceTest() {
    super(context);
  }
  ...
  public static void setup() throws Exception {
    context =
        DataprocAcceptanceTestBase.setup(
            "2.2-debian12", CONNECTOR_JAR_DIRECTORY, "spark-3.2-spanner", ImmutableList.of());
  }
