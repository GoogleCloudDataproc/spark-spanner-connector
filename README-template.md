...
|-----------|------------------------------------------------------------------------|
| Spark 4.1 | `com.google.cloud.spark.spanner:spark-4.1-spanner:${next-release-tag}` |
| Spark 4.0 | `com.google.cloud.spark.spanner:spark-4.0-spanner:${next-release-tag}` |
...
indexHint|String|The column name to use as a secondary index. This overrides Google Cloud Spanner's automatic query optimizer and forces the database engine to use a specific secondary index.
