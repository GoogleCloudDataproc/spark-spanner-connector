...
public class Spark32SpannerTableProviderTest extends SparkSpannerIntegrationTestBase {

  @Test
  public void getTableForWrite_withenablePartialRowUpdates_returnsTableWithDataFrameSchema() {
    // Arrange
    Spark32SpannerTableProvider provider = new Spark32SpannerTableProvider();
