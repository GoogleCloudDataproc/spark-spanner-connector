...
public class FunctionsAndExpressions35IntegrationTest extends SparkSpannerIntegrationTestBase {
  ...
  public static Iterable<Object[]> data() {
    if (SpannerTableIntegrationTest.emulatorHost != null
      ...
      System.out.println(
          "FunctionsAndExpressions35IntegrationTest is skipped since pg is not supported in Spanner emulator");
  ...
  public FunctionsAndExpressions35IntegrationTest(boolean isPostgreSql) {
