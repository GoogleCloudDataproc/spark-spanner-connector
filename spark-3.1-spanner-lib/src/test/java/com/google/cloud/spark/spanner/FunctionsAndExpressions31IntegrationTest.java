...
public class FunctionsAndExpressions31IntegrationTest extends SparkSpannerIntegrationTestBase {
  ...
  public static Iterable<Object[]> data() {
    if (SpannerTableIntegrationTest.emulatorHost != null
      ...
      System.out.println(
          "FunctionsAndExpressions31IntegrationTest is skipped since pg is not supported in Spanner emulator");
  ...
  public FunctionsAndExpressions31IntegrationTest(boolean isPostgreSql) {
