...
public class Spark33SpannerTableProviderTest extends SparkSpannerIntegrationTestBase {

  @Test
  public void getTableForWrite_withenablePartialRowUpdates_returnsTableWithDataFrameSchema() {
    // Arrange
    Spark33SpannerTableProvider provider = new Spark33SpannerTableProvider();
