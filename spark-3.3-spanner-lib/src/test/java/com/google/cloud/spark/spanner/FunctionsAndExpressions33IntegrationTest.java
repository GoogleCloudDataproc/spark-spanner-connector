...
public class FunctionsAndExpressions33IntegrationTest extends SparkSpannerIntegrationTestBase {
  ...
  public static Iterable<Object[]> data() {
    if (SpannerTableIntegrationTest.emulatorHost != null
      ...
      System.out.println(
          "FunctionsAndExpressions33IntegrationTest is skipped since pg is not supported in Spanner emulator");
  ...
  public FunctionsAndExpressions33IntegrationTest(boolean isPostgreSql) {
