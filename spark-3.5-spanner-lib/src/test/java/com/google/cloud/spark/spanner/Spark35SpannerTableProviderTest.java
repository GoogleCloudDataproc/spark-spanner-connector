...
public class Spark35SpannerTableProviderTest extends SparkSpannerIntegrationTestBase {

  @Test
  public void getTableForWrite_withenablePartialRowUpdates_returnsTableWithDataFrameSchema() {
    // Arrange
    Spark35SpannerTableProvider provider = new Spark35SpannerTableProvider();
