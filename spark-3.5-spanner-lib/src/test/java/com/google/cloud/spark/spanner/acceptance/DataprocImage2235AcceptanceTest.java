...
public final class DataprocImage2235AcceptanceTest extends DataprocAcceptanceTestBase {

  private static AcceptanceTestContext context;
  public static final String CONNECTOR_JAR_DIRECTORY = "../spark-3.5-spanner/target";

  public DataprocImage2235AcceptanceTest() {
    super(context);
  }
  ...
  public static void setup() throws Exception {
    context =
        DataprocAcceptanceTestBase.setup(
            "2.2-debian12", CONNECTOR_JAR_DIRECTORY, "spark-3.5-spanner", ImmutableList.of());
  }
