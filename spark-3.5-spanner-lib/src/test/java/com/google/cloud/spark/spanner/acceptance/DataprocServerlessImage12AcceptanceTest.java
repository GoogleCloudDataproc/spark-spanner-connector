...
public final class DataprocServerlessImage12AcceptanceTest
    extends DataprocServerlessAcceptanceTestBase {

  public static final String CONNECTOR_JAR_DIRECTORY = "../spark-3.5-spanner/target";

  public DataprocServerlessImage12AcceptanceTest() {
    super(CONNECTOR_JAR_DIRECTORY, "spark-3.5-spanner", "1.2");
  }
}
