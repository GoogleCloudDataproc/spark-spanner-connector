...
public final class Spark32DataprocImage21AcceptanceTest extends DataprocAcceptanceTestBase {
  ...
  public static void setup() throws Exception {
    context =
        DataprocAcceptanceTestBase.setup(
            "2.1-debian11", CONNECTOR_JAR_DIRECTORY, "spark-3.2-spanner", ImmutableList.of());
  }
