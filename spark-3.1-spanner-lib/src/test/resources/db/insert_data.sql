...
VALUES
    (1,  "2",  NULL, TIMESTAMP("2023-08-22T12:22:00Z"), NUMERIC '1000.282111401', true, -0.1, DATE("2023-12-31T00:00:00Z"), -0.1),
    (10, "20", NULL, TIMESTAMP("2023-08-22T12:23:00Z"), NUMERIC '10000.282111603', false, 0.2, DATE("2024-01-01T00:00:00Z"), NULL),
    (30, "30", NULL, TIMESTAMP("2023-08-22T12:24:00Z"), NUMERIC '30000.282111805', false, 0.1, DATE("2025-01-01T00:00:00Z"), -0.1);

INSERT INTO
    ATable(A, B, C, D, E, F, G, H, I, J, K)
VALUES
    (40, "40", b'xyz', TIMESTAMP('2025-01-01T12:34:56Z'), NUMERIC '123.456789123', TRUE,3.14, DATE ("2025-01-01"), ['a','b','c'], JSON '{"name":"john"}', NULL);
